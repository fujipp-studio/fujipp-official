-- Preserve purchased-license order ownership while transferring a bot.
-- The original purchase remains with its purchaser for audit history. The
-- transferred bot receives a one-seat grant carrying the same feature state.
